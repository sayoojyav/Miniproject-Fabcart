 ...
 <div class="sidebar-fixed position-fixed">
  <div>
    <h2 class="text-primary font-weight-bold deep-orange-lighter-hover mb-3 logo-wrapper">
      <b>FABCART</b>
    </h2>
  </div>
  <div class="list-group list-group-flush">
    <a href="{{ url('/dashbord') }}" class="list-group-item active waves-effect">
      <i class="fa fa-pie-chart mr-3"></i>Dashboard</a>
    <a href="{{ url('profile') }}" class="list-group-item list-group-item-action waves-effect">
      ...
      <div class="dropdown">
        <a href="" class="list-group-item list-group-item-action waves-effect dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <i class="fa fa-user mr-3"></i> Collections</a>
